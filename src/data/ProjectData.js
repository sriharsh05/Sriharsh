...
export const ProjectList = [
  {
    ...
    title: "Sports Pulse",
    description:
      "Personalized Sports News and Score Tracker",
    tech_stack: ["React JS", "Type Script", "TailwindCSS"],
    github_url: "https://github.com/sriharsh05/SportsPulse",
  ...
  {
    img: "/solar-vision.png",
    title: "Solar Vision",
    description:
      "Predicting Solar Energy Generation and Revenue Estimation using Machine Learning and Time Series Analysis",
    tech_stack: ["Flask", "Numpy", "Pandas", "Time series analysis"],
    github_url: "https://github.com/sriharsh05/SolarVision",
    demo_url: "",
  },
  {
    img: "/work-assist.png",
    title: "Work Assist",
    description:
      "An Android app assists in finding household workers.",
    tech_stack: ["Android(Java)", "SQLite"],
