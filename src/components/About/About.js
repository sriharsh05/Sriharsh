          ...
          <div className="AboutBio">
            <VerticalTimeline>
              <VerticalTimelineElement
                ...
                icon={WorkIcon}
              >
                <h3 className="vertical-timeline-element-title">Associate technical support engineer</h3>
                <h4 className="vertical-timeline-element-subtitle">
                  Salesforce India
                </h4>
                <p>
                  Global leader in CRM software, driving customer relationships
                  and business growth through cloud-based solutions and social
              ...
              >
                ...
                <p>
                  Deputed to eGovernment foundation to develop Tele-ICU tooling
                  for 10bedICU project.
                </p>
              </VerticalTimelineElement>
              <VerticalTimelineElement
                className="vertical-timeline-element--work"
